const CACHE="cabin-drinks-v13";
const SHELL=["./","./index.html","./app.html","./landing.css","./history.css","./landing.js","./style.css","./multi-order.css","./help.css","./v7.css","./v8.css","./delivery-details.css","./v10.css","./app.js","./manifest.json","./app-icon.svg"];
