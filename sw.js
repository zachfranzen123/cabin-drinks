const CACHE="cabin-drinks-v6";
const SHELL=["./","./index.html","./app.html","./landing.css","./landing.js","./style.css","./multi-order.css","./help.css","./app.js","./manifest.json","./app-icon.svg"];
